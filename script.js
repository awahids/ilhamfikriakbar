...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('Apr 07, 2021 00:00:00').getTime(),
...
new TypeIt("#teks1", {
  strings: ["Assalamualaikum Wr. Wb",
            " ", "Hari ini, 07 April 2021",
            " ","<b>Selamat Ulang Tahun Yang ke - 2</b>",
            " ", "Kepada Ilham Fikri Akbar, semoga jadi anak yang sholeh dan berguna bagi keluarga dan orang-orang di sekelilingnya Aamiin.",
            " ", "Wassalamualakaikum Wr. Wb",
            " ", "- A Wahid Safhadi, Baba Saf"
            ],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["Haii iki!!", "Yaumul Milad ya..",
            " ", "Udah 2 tahun, terasa baru kemarin baba saf gendong, semoga di umur yang sekarang kamu bisa jadi anak yang baik, sholeh,dan berbakti.",
